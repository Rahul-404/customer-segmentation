...
from customer_segmentation.pipeline.prediction_pipeline import PredictionPipeline, CustomerData
from customer_segmentation.pipeline.train_pipeline import TrainPipeline
from customer_segmentation.constant.application import *
...
async def predictRouteClient(request: Request):
    try:
        ...
        predict_cluster = prediction_pipeline.run_pipeline(input_data=input_data)
